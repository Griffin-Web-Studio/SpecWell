...
import useWebInstallPrompt from "../../../src/hooks/useWebInstallPrompt";
        ...
        <div className="gwssc-install-pwa-prompt">
            <div className="gwssc-install-pwa-prompt__container-outer">
                ...
                <div className="gwssc-install-pwa-prompt__container-inner">
                    <h2 className="gwssc-h3 gwssc-aligncenter">
                        Install this website as a PWA
                    </h2>
                    <p>
                        Please note that this app does not require you to
                        ...
                        {iosInstallPrompt && (
                            <>
                                <div className="gwssc-aligncenter">
                                    <p>
                                        Tap{" "}
                                        <span className="icon-apple-share"></span>{" "}
                                        then &quot;Add to Home Screen&quot;
                                    </p>
                                </div>
                                <button
                                    className="gwssc-button__secondary gwssc-button__secondary--radius gwssc-button__secondary--large-font gwssc-button__secondary--width-auto gwssc-aligncenter"
                            ...
                            <>
                                ...
                                <div className="gwssc-grid gap-col-10">
                                    <div className="gwssc-grid-12">
                                        <button
                                            className="gwssc-button gwssc-button--radius"
                                    ...
                                    <div className="gwssc-grid-12">
                                        <button
                                            className="gwssc-button__secondary gwssc-button__secondary--radius"
